...
}s;  //object of classs student

// Main function

int main()
{
    project(); //fuction call
    return 0;

}

// prroject function declaration
...
void project()
{
    ...
    do
    {
        ...
        switch (ch)
        {
            ...
            case 4:
                getTrash();   // add data from Tash.txt to stu.txt
                break;
        }
        system("pause");
    } while (ch);
...

{
    ...
    {
        s.showData(); //display data to console
    }

    fin.close();
    cout << "\n\n************Data Reading from Trash File Successfully************\n";
}